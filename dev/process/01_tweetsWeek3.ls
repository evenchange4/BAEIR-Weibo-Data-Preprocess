...
$sequelize.sync <[ TweetsWeek3 ]> .then (msg)!->
  ...
  lr.on \line, (line) !->
    ...
    TweetsWeek3.create { mid, retweeted_status_mid, uid, retweeted_uid, source, image, text, geo, created_at, deleted_last_seen, permission_denied }
    .success !->
