...
$sequelize.sync <[ TweetsWeek2 ]> .then (msg)!->
  ...
  lr.on \line, (line) !->
    ...
    TweetsWeek2.create { mid, retweeted_status_mid, uid, retweeted_uid, source, image, text, geo, created_at, deleted_last_seen, permission_denied }
    .success !->
      # console.log "Created Successful"
    .error (d)!->
      console.log "[#{moment!format("YYYY-MM-DD HH:mm:ss.SSS")}] [DB Error] Created error: #{d}"
      console.log line
      TweetsWeek2.update { +duplicated }, where: { mid }
